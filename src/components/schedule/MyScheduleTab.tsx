...
const defaultActivities: ScheduledActivity[] = [
  ...
  // --- Additional events to reach 16 total ---
  {
    id: '10',
    date: '2026-04-18',
    time: '8:00 AM',
    title: 'Sunrise Pool & Spa Session',
    location: 'Resort Spa & Pool',
    description: 'Start your resort experience with a relaxing morning swim and spa access',
    whatToWear: ['Swimwear', 'Flip flops', 'Comfortable robe'],
    preparation: [
      'Apply sunscreen before arrival',
      'Stay hydrated',
      'Bring your own goggles if preferred',
    ],
    image: '/comfort-hero.jpg',
    completed: false,
  },
  {
    ...
    date: '2026-04-18',
    time: '3:30 PM',
    title: 'Ethiopian Art & Painting Workshop',
    location: 'Art Gallery',
    description: 'Create your own Ethiopian-inspired artwork guided by local artists',
    whatToWear: ['Casual clothes that can get paint on them'],
    preparation: [
  ...
  },
  {
    ...
    date: '2026-04-19',
    time: '11:00 AM',
    title: 'Traditional Music & Dance Lesson',
    location: 'Cultural Hall',
    description: 'Learn traditional Ethiopian dances like Eskista with live musicians',
    whatToWear: ['Comfortable clothes for movement', 'Flat shoes'],
    preparation: [
      'Warm up your shoulders — Ethiopian dance uses them a lot!',
  ...
  },
  {
    ...
    date: '2026-04-19',
    time: '6:30 PM',
    title: 'Stargazing & Ethiopian Astronomy',
    location: 'Rooftop Terrace',
    description: 'Learn how Ethiopian culture interprets the stars, with hot cocoa',
    whatToWear: ['Warm layers', 'Comfortable shoes'],
    preparation: [
      'Dress warmly — it gets cool at night',
      'Avoid looking at bright screens beforehand',
    ],
    image: '/comfort-hero.jpg',
    completed: false,
  },
  {
    ...
    description: 'A guided walk through the resort gardens with bird watching',
    whatToWear: ['Walking shoes', 'Light jacket'],
    preparation: [
  ...
  },
  {
    ...
    date: '2026-04-20',
    time: '12:00 PM',
    title: 'Spice Market & Cooking Demo',
    location: 'Outdoor Kitchen',
    description: 'Explore Ethiopian spices and watch a live cooking demonstration',
    whatToWear: ['Casual, comfortable clothing'],
    preparation: [
      'Come with an appetite',
      'Note any allergies before attending',
    ],
    image: '/gebeta-hero.jpg',
    completed: false,
  },
  {
    ...
    date: '2026-04-20',
    time: '4:00 PM',
    title: 'Photo Walk & Resort Tour',
    location: 'Meet at Lobby',
    description: 'Capture the best shots of the resort with a professional photographer guide',
    whatToWear: ['Comfortable walking shoes'],
    preparation: [
