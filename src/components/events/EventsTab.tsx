...
const meetingHalls: MeetingHall[] = [
  ...
  { id: 'hall4', name: 'Gamal Abdel Nasser Hall', image: 'https://images.unsplash.com/photo-1431540015159-0f9673fb2253?w=800&q=80', capacity: '95 sqm', features: ['WiFi', 'Smart TV', 'Sound System', 'Recording equipment'], description: 'A serene environment for meaningful exchanges.', pricePerHour: '$80/hour' },
